...
class FindFacilityTypes(Action):
    ...
    for the user to chose to fill the facility_type entity slot."""
...
class FindHealthCareAddress(Action):
    """This action class retrives the address of the user's
    healthcare facility chocie to display it to the user."""
    ...
    def run(self,
        ...
        facility_id   = tracker.get_slot("facility_type")
...
class FacilityForm(FormAction):
    ...
    def submit(self,
            ...
            """Once required slots are filled, print buttons for facilities"""

            location = tracker.get_slot('location')
            facility_type = tracker.get_slot('facility_location')
            ...
            for r in results[:3]:
                ...
                elif facility_type == FACILITY_TYPES["nursing"]["resource"]:
